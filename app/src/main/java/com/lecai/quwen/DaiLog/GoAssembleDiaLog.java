...
public class GoAssembleDiaLog extends BaseDiaLog {
    public GoAssembleDiaLog(Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_go_assemble);Window window = this.getWindow();
